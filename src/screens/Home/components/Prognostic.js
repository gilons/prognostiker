...
export default function Prognostic(props) {
    ...
    const [teamPhoto, setTeamPhoto] = useState(defaultTeam.url || defaultTeam.flag);
    ...
    return (
        <View style={styles.prognosticItem(reverse)}>
            <TouchableOpacity onPress={changePhoto}>
                <PImage resizeMode={'stretch'} style={styles.prognosticImage} source={{ uri: teamPhoto }} rounded large />
            </TouchableOpacity>
            <TextInput
                autoFocus
